...
export default {
  ...
  if (response.success) {
    localStorage.setItem('token', response.data.access_token); // Сохранение токена
    localStorage.setItem('roles', JSON.stringify(response.data.user.roles)); // Сохранение ролей пользователя
